...
def eval_lr(trainx, trainy, testx, testy):
    ...
    lr_model = skl.LogisticRegression(max_iter=1000, penalty=None, solver='saga') 
    ...
    train_prob = lr_model.predict_proba(trainx)[:, 1]  
    ...
    test_prob = lr_model.predict_proba(testx)[:, 1]  
